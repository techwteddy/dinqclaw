...
const RISKS = [
  {
    ...
    answer: "DinqClaw runs on Composio's managed tool surface instead.",
  },
  {
    label: "EXPOSED CREDENTIALS",
    description:
      "API keys stored in plaintext on your machine. 900+ instances found leaking tokens.",
    answer: "DinqClaw never gives the agent a raw key.",
  },
  {
    ...
    answer: "DinqClaw sandboxes all execution remotely.",
  },
] as const;
